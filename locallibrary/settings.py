...
# SECRET_KEY = 'django-insecure-at$pn(06_8^%aq2vp)p=y)(o@=q_pyb(%mm(629(=jb=qj(718'
...
INSTALLED_APPS = [
    ...
    'django.contrib.contenttypes', #Django content type system(allow permissions to be associated with models).
